...
module EffectUtils {
    ...
    */
    export function playEffect(obj,cartoonType:number = 1,callback?:Function,data?:any):void{
        ...
        var onComplete1:Function = function(){
            if(cartoonType == 1){
                ...
                egret.Tween.get(obj).to({scaleX:1,scaleY:1,x:obj.x - obj.width/4,y:obj.y - obj.height/4},200,egret.Ease.backOut).call(onComplete2,this); 
            }else if(cartoonType == 3){
                egret.Tween.get(obj).to({scaleX:3,scaleY:3,x:obj.x - obj.width/4,y:obj.y - obj.height/4},100).call(onComplete2,this); 
            }
        };   
